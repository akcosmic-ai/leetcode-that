/*
 * TEMPLATE: Two pointers: inward, same-direction, two-array
 *
 * Inward walking is for palindromes and sorted pair-sums. Same-direction (slow
 * writes, fast scans) is for in-place removal. The third shape walks two
 * sorted arrays at once. Note that l and r each move only one way, which is
 * why two pointers is still O(n).
 *
 * Generated from data/templates/two-pointers.js.
 */
package lct.templates.twopointers;
