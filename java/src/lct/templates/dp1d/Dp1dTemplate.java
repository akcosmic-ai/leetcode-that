/*
 * TEMPLATE: 1-D DP: top-down memo, bottom-up table, rolling variables
 *
 * Write the meaning of dp[i] as an English sentence above the loop, every
 * time. The three shapes here are the same algorithm at three levels of
 * polish: memoised recursion, a table, then two variables. Seed a memo with
 * -1, never 0, unless 0 can never be a real answer.
 *
 * Generated from data/templates/dp-1d.js.
 */
package lct.templates.dp1d;
