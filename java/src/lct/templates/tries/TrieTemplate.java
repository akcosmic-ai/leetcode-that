/*
 * TEMPLATE: Trie: insert, search, startsWith
 *
 * The node is the whole idea: 26 child slots plus a boolean saying a word ENDS
 * here. search and startsWith differ by exactly that boolean. Cost depends on
 * word length, never on how many words are stored.
 *
 * Generated from data/templates/tries.js.
 */
package lct.templates.tries;
