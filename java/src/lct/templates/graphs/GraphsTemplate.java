/*
 * TEMPLATE: Graphs: grid DFS/BFS, adjacency BFS, topological sort, union-find
 *
 * Mark visited when you ENQUEUE, not when you dequeue, or the same cell enters
 * the queue many times. BFS gives shortest path in an unweighted graph; DFS
 * does not. Union-Find with path compression is effectively O(1) per query.
 *
 * Generated from data/templates/graphs.js.
 */
package lct.templates.graphs;
