/*
 * TEMPLATE: Math & geometry: digit walk, safe reverse, rotate, spiral, gcd, sieve
 *
 * Rotate 90 degrees clockwise = transpose, then reverse each row. Far easier
 * to get right than moving four corners at a time. Digit problems are n % 10
 * and n / 10. Check for overflow BEFORE you multiply, not after.
 *
 * Generated from data/templates/math-geometry.js.
 */
package lct.templates.mathgeometry;
