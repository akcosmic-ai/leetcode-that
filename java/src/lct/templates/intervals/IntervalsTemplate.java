/*
 * TEMPLATE: Intervals: merge, non-overlapping greedy, sweep line
 *
 * Which endpoint you sort by decides the problem. Sort by START to merge. Sort
 * by END to keep the most non-overlapping intervals. Split starts and ends
 * into two sorted arrays to count concurrency.
 *
 * Generated from data/templates/intervals.js.
 */
package lct.templates.intervals;
