(window.LC_TEMPLATES = window.LC_TEMPLATES || {})['bit-tricks'] = {
  id: 'bit-tricks',
  name: 'Bit manipulation: XOR, popcount, masks, subset enumeration',
  pattern: 'bit-manipulation',
  order: 16,
  notes: 'Two XOR facts do most of the work: `x ^ x == 0` and `x ^ 0 == x`. Memorise `x & (x - 1)` (clears the ' +
         'lowest set bit) and `x & -x` (isolates it). Parenthesise everything: `&` binds looser than `==`.',
  code: `class BitTemplate {
