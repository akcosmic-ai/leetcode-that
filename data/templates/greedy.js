(window.LC_TEMPLATES = window.LC_TEMPLATES || {})['greedy-scan'] = {
  id: 'greedy-scan',
  name: 'Greedy: Kadane, reach, sort-then-take',
  pattern: 'greedy',
  order: 14,
  notes: 'Every one of these is a single pass with one or two running variables. Before you trust a greedy rule, ' +
         'try to break it with a small adversarial input. If you cannot break it, and you can say why, use it.',
