(window.LC_TEMPLATES = window.LC_TEMPLATES || {})['backtracking'] = {
  id: 'backtracking',
  name: 'Backtracking: subsets, combinations, permutations',
  pattern: 'backtracking',
  order: 10,
  notes: 'Choose, explore, un-choose. The un-choose line is the pattern. Combinations pass a `start` index so ' +
         'each element is considered once; permutations use a `used[]` flag so order matters. Always copy the ' +
         'path when you store it.',
