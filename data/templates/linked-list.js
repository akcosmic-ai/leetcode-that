(window.LC_TEMPLATES = window.LC_TEMPLATES || {})['linked-list-reverse'] = {
  id: 'linked-list-reverse',
  name: 'Linked list: dummy head, reverse, fast & slow',
  pattern: 'linked-list',
  order: 6,
  notes: 'Three moves cover nearly every linked-list problem. Dummy head removes the "what if it is the first ' +
         'node" special case. Three-pointer reverse walks once. Fast and slow finds the middle and detects a ' +
         'cycle in one pass. Save `next` BEFORE you overwrite it, every time.',
  code: `class LinkedListTemplate {
