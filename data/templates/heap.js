(window.LC_TEMPLATES = window.LC_TEMPLATES || {})['heap-top-k'] = {
  id: 'heap-top-k',
  name: 'Heap: top k, k-th largest, merge, two-heap median',
  pattern: 'heap',
  order: 9,
  notes: 'For the k LARGEST, keep a MIN-heap of size k. It reads backwards and it is correct: the weakest of ' +
         'your current best k sits on top, so it is the cheapest to evict. That is what makes it O(n log k) ' +
