(window.LC_TEMPLATES = window.LC_TEMPLATES || {})['monotonic-stack'] = {
  id: 'monotonic-stack',
  name: 'Stack: matching, monotonic next-greater, iterative DFS',
  pattern: 'stack',
  order: 4,
  notes: 'The monotonic stack is the one worth memorising. Read the loop as: "while the thing I am holding is ' +
         'smaller than what just arrived, the answer for the thing I am holding IS what just arrived." Push ' +
         'indexes, not values, whenever the answer is positional.',
